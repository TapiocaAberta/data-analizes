...
public class Constantes {
    ...
    public static final String DOC_RELACIONADOS_PATH = ORIGINAIS_PATH + "documentos-relacionados/";
    public static final String DOC_DETALHES_PATH = ORIGINAIS_PATH + "documentos-detalhes/";
    
    public static final String EXECUTADO_FOLDER = "/executado/";
